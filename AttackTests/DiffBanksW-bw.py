...
file_path = sys.argv[1]+'attack/sepbanksW-bw.csv'
...
plt.axhline(y=1000, color='black', linestyle='--', linewidth=1, label="Ref Line (y=1000)")

plt.xlabel('WSS(KB)')
plt.ylabel('Bandwidth(MB/s)')
plt.title('BeagleV Bankisol (BkPLL victim) BW -- Write')
plt.legend()

plt.xticks(x,x)

plt.grid(True)
plt.savefig('bankisolW-bw_test.png')
